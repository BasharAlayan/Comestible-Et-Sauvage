...
public class ResultFontaineSearch extends AppCompatActivity {
    private Database_Res_Fon dataBase;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        actionBar.setTitle("les Details des Fontaines");
        mlistView = findViewById(R.id.listviewResultSearch);
        dataBase = new Database_Res_Fon(this);
        listview_DB();
    }

    private void listview_DB() {
        int numberRow = dataBase.CountFontaines();
